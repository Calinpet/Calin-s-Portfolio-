...
export default function BackgroundCircles({}: Props) {
  return (
    ...
    className='elative flex justify-center items-center'>

      <div className='absolute border border-[border-blue-500] rounded-full h-[200px] w-[200px] mt-52 animate-ping' />
      <div className='rounded-full border border-blue-500 h-[300px] w-[300px] absolute mt-52' />
      <div className='rounded-full border border-blue-500 h-[500px] w-[500px] absolute mt-52 ' />
